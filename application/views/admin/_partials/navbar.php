<nav class="navbar navbar-expand navbar-dark static-top" style="background-image: linear-gradient( green 20% , yellow 99% )">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false">
                <i class="fas fa-user-circle fa-fw"></i> <?php echo $this->session->userdata("user_logged")->Username; ?>
            </a>
